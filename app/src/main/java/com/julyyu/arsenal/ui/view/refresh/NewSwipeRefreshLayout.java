...
public class NewSwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    private NewSwipeRefreshLayout.OnChildScrollUpCallback mChildScrollUpCallback;
...
//        setColorSchemeResources(colors);
     ...
     */
    public void setOnChildScrollUpCallback(@Nullable NewSwipeRefreshLayout.OnChildScrollUpCallback callback) {
    ...
    public void onNestedScroll(final View target, final int dxConsumed, final int dyConsumed,
        ...
        LogUtils.printI("nweswipe", "onNestedScroll " + "dxConsumed:" + dxConsumed + "\n" +
    ...
    public boolean startNestedScroll(int axes) {
        LogUtils.printI("nweswipe", "startNestedScroll " + "axes:" + axes );
    ...
    public boolean dispatchNestedPreScroll(int dx, int dy, int[] consumed, int[] offsetInWindow) {
        LogUtils.printI("nweswipe", "dispatchNestedPreScroll " + "dx:" + dx + "\n" +
            "dy:" + dy +
                "consumed:" + consumed + "\n" +
    ...
    public interface OnChildScrollUpCallback {
         ...
         */
        boolean canChildScrollUp(NewSwipeRefreshLayout parent, @Nullable View child);
    }
}
